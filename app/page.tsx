...
import React from 'react'; import Link from 'next/link'; import Image from 'next/image';
    ...
    return (
        ...
        <div className="flex justify-between items-center p-4 bg-white shadow-md">
          <div className="flex space-x-4">
            <button className="text-gray-700">
              <Image src="/file.svg" alt="Search" className="w-6 h-6"   width={50}    height={50} />
            </button>
            <button className="text-gray-700">
              <Image src="/file.svg" alt="WeChat" className="w-6 h-6"  width={50}    height={50} />
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-200 py-2 text-sm text-gray-600">
          <div className="max-w-7xl mx-auto px-6">
            ...
            {' > '}
            <Link href="/fish-pond-knowledge" className="hover:text-blue-600">
              鱼塘知识
            </Link>
            {' > '}
            清塘方法
      ...
      {/* 文章主体部分 */}
      <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col lg:flex-row">
        {/* 左侧内容 */}
  ...
  <div className="w-full lg:w-1/3 lg:ml-8 mt-8 lg:mt-0">
        ...
        <div className="bg-white p-4 shadow-md">
          ...
          <ul className="space-y-3">
            <li><Link href="/article-1" className="text-blue-600 hover:underline">鱼塘管理技巧</Link></li>
            <li><Link href="/article-2" className="text-blue-600 hover:underline">清塘与水质管理</Link></li>
            <li><Link href="/article-3" className="text-blue-600 hover:underline">养殖池塘的常见问题</Link></li>
          </ul>
        </div>
      </div>
    </div>
